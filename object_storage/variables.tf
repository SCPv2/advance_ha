...
########################################################
# 3. PostgreSQL DBaaS 변수 (DBAAS_VARIABLES)
#    PostgreSQL DBaaS 서비스 관련 변수들
########################################################

variable "dbaas_cluster_name" {
  type        = string
  description = "[DBAAS] PostgreSQL cluster name"
  default     = "cedbcluster"
}

variable "dbaas_server_name_prefix" {
  type        = string
  description = "[DBAAS] PostgreSQL server name prefix"
  default     = "cedbserver"
}

variable "dbaas_server_type" {
  type        = string
  description = "[DBAAS] PostgreSQL server type"
  default     = "db1v2m4"
}

variable "dbaas_os_disk_size" {
  type        = number
  description = "[DBAAS] PostgreSQL OS disk size in GB"
  default     = 104
}

variable "dbaas_data_disk_size" {
  type        = number
  description = "[DBAAS] PostgreSQL data disk size in GB"
  default     = 16
}

variable "dbaas_data_disk_type" {
  type        = string
  description = "[DBAAS] PostgreSQL data disk type"
  default     = "SSD"
}

variable "dbaas_ha_enabled" {
  type        = bool
  description = "[DBAAS] Enable High Availability for PostgreSQL"
  default     = false
}

variable "dbaas_nat_ip_address" {
  type        = string
  description = "[DBAAS] PostgreSQL NAT IP address"
  default     = "10.1.3.132"
}

variable "dbaas_timezone" {
  type        = string
  description = "[DBAAS] PostgreSQL timezone"
  default     = "Asia/Seoul"
}

variable "dbaas_database_encoding" {
  type        = string
  description = "[DBAAS] PostgreSQL database encoding"
  default     = "UTF-8"
}

variable "dbaas_database_locale" {
  type        = string
  description = "[DBAAS] PostgreSQL database locale"
  default     = "C"
}

variable "dbaas_audit_log_enabled" {
  type        = bool
  description = "[DBAAS] Enable PostgreSQL audit log"
  default     = false
}

variable "dbaas_backup_enabled" {
  type        = bool
  description = "[DBAAS] Enable PostgreSQL backup"
  default     = false
}

variable "dbaas_backup_period" {
  type        = string
  description = "[DBAAS] PostgreSQL backup period"
  default     = "DAILY"
}
...
variable "db_ip2" {
  type        = string
  description = "Private IP address of DBaaS Standby node [TERRAFORM_INFRA]"
  default     = "10.1.3.33"
}
...
variable "security_group_dbaas" {
  type        = string
  description = "Security group name for DBaaS [TERRAFORM_INFRA]"
  default     = "dbaasSG"
}
