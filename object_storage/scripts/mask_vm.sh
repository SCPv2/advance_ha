#!/bin/bash
# Virtual Server Masking Script for object_storage
...
echo -e "${CYAN}Object Storage Environment${NC}"
echo -e "${CYAN}========================================${NC}"
echo ""
...
fix_depends_on_lines() {
    ...
    # For object_storage, we'll use a simpler approach since there are no depends_on with VMs
...
main() {
    ...
    echo -e "  • Virtual Servers masked: vm1, vm2, vm3"
