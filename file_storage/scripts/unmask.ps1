# Virtual Server Unmasking Script for file_storage (PowerShell Version)
...
try {
    ...
    Write-Host "  • All Virtual Servers re-enabled: vm1 (bastion), vm2/vm2_2 (web), vm3/vm3_2 (app), vm4 (db)" -ForegroundColor White
